import { CALENDLY_LINK, WISTIA_MEDIA_ID } from "../config";
...
export function Hero({ onCtaClick }: HeroProps) {
  ...
  return (
    ...
    >
      {/* Absolute radial amber glow in bottom right of the hero section */}
      ...
      {/* Qualifier Bar (Contained dark pill floating header) */}
      <div className="z-20 w-[calc(100%-24px)] md:w-auto max-w-[960px] mx-[12px] md:mx-auto mt-[12px] mb-[20px] bg-[#000000] border border-white/5 rounded-[8px] md:rounded-[12px] py-[8px] px-[14px] md:py-[14px] md:px-[20px] flex-shrink-0">
        <p className="text-[11px] md:text-[13px] text-white font-normal text-center leading-normal">
          {copyData.qualifier}
        </p>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1100px] mt-0 px-4 md:px-[48px] flex flex-col items-center">
        ...
        {/* Subheadline with muted light grey color */}
